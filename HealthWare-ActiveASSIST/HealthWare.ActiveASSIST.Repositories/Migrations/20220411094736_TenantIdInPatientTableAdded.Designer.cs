...
namespace HealthWare.ActiveASSIST.Repositories.Migrations
{
    ...
    [Migration("20220411094736_TenantIdInPatientTableAdded")]
    partial class TenantIdInPatientTableAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthWare.ActiveASSIST.Entities.HouseHoldMember", b =>
                {
                    ...
                    b.Property<bool>("CanDeleteHousehold")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("HealthWare.ActiveASSIST.Entities.Option", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Order = 1,
                            QuickAssessmentQuestionsId = 36L,
                            Value = "No"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Order = 1,
                            QuickAssessmentQuestionsId = 37L,
                            Value = "No"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("HealthWare.ActiveASSIST.Entities.Patient", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("HealthWare.ActiveASSIST.Entities.ReasonNoSsn", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Healthware.Core.Entities.MainUser", b =>
                {
                    ...
                    b.Property<long?>("SecondaryEmailContactDetailsId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SecondaryEmailContactDetailsId");
            ...
            modelBuilder.Entity("HealthWare.ActiveASSIST.Entities.UserAccount", b =>
                {
            ...
            modelBuilder.Entity("Healthware.Core.MultiTenancy.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$12$CDdVp2vRJbSBpt6gBoUz8OIdjhQ7fz8bOe36gPMuvBm5aEKayQFWy"
                        },
                        new
                        {
                            Id = 1L,
                            ...
                            Password = "$2a$12$bjUuobuv23nK/LXOGOgCku/ByUsO90dDbOgPT2wu5Qji/GpOjbNNu",
                            SSNNumber = "212128812",
                            SecondaryEmailContactDetailsId = 3L,
                            TenantId = "1"
                        },
                        new
                        {
                            ...
                            Password = "$2a$12$c1XJX0g47qnPeeXdoPek.Owl04yrZnQuaE2ARIjjtTZpQnpE.W3jK",
                            SSNNumber = "212127744",
                            SecondaryEmailContactDetailsId = 5L,
                            TenantId = "1"
                        },
                        new
                        {
                            ...
                            LastName = "Kucherina",
                            MaritalStatus = "Single",
                            Password = "$2a$12$.orfCni8RWvmpun72L.pFuLxElN7l5ML1DgB3OdKBT8FFNReLT0ki",
                            SSNNumber = "212127766",
                            SecondaryEmailContactDetailsId = 7L,
                            TenantId = "1"
                        },
                        new
                        {
                            ...
                            LastName = "Raman",
                            MaritalStatus = "Single",
                            Password = "$2a$12$znokUhLbWivlS8rOGm5Na.9HJh/KDEnx17Xu.4toKQ/yNNq3bO0mG",
                            SSNNumber = "212127788",
                            SecondaryEmailContactDetailsId = 9L,
                            TenantId = "1"
                        },
                        new
                        {
                            ...
                            LastName = "Kunwar",
                            MaritalStatus = "Single",
                            Password = "$2a$12$itxq/zxNqq3.XW34YL0a6uJ6CGYR9fA9d1aYyX5JrYdA3uSJHqSN.",
                            SSNNumber = "212127724",
                            SecondaryEmailContactDetailsId = 11L,
                            TenantId = "1"
                        },
                        new
                        {
                            ...
                            LastName = "Gruner",
                            MaritalStatus = "Single",
                            Password = "$2a$12$T7HJQZ7M2tl8EmzQSHp3be8AHQYwznQUNjf4qpIis0ABrMUA0QZBe",
                            SSNNumber = "212126682",
                            SecondaryEmailContactDetailsId = 13L,
                            TenantId = "1"
                        },
                        new
                        {
                            ...
                            LastName = "Kumar",
                            MaritalStatus = "Single",
                            Password = "$2a$12$UM3Qlgf7qMdGxwBu3WhjgeS3IVdKKfpRQStL1oPblgxtibzYcbZ0G",
                            SSNNumber = "215526682",
                            SecondaryEmailContactDetailsId = 15L,
                            TenantId = "3"
                        },
                        new
                        {
                            ...
                            LastName = "Raja",
                            MaritalStatus = "Married",
                            Password = "$2a$12$OeXzP1bLkvrs56bSusFyxe/DKCNSkiNk/mbdNEa6cXtjHKwP7B5w.",
                            SSNNumber = "215526999",
                            SecondaryEmailContactDetailsId = 17L,
                            TenantId = "3"
                        });
                });
            ...
            modelBuilder.Entity("Healthware.Core.Entities.MainUser", b =>
                {
                    ...
                    b.HasOne("Healthware.Core.Entities.ContactDetails", "SecondaryEmailContactDetails")
                        .WithMany()
                        .HasForeignKey("SecondaryEmailContactDetailsId");

                    b.Navigation("ContactDetails");

                    b.Navigation("SecondaryEmailContactDetails");
                });
            ...
            modelBuilder.Entity("HealthWare.ActiveASSIST.Entities.UserAccount", b =>
                {
                    b.HasOne("HealthWare.ActiveASSIST.Entities.Patient", "Patient")
                        .WithMany()
