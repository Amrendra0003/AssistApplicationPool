            ...
            if (e.ChangeType == WatcherChangeTypes.Changed)
            {
                ...
                try
                {
                    if (fileExtension.Equals(ApplicationConstant.CSVFileExtension) && File.Exists(e.FullPath))
                    {
                        ...
                        {
                            var processedFilesPath = $@"C:\inetpub\wwwroot\ActiveASSISTUserImportForFaculty\{tenantId}\ProcessedFiles\";
                    ...
                    {
                        var failedFilesPath = $@"C:\inetpub\wwwroot\ActiveASSISTUserImportForFaculty\{tenantId}\FailedFiles\";
