    ...
    public static class StringExtensions
    {
      ...
      separator
        ...
        public static bool IsIso8601ExtenededFormat(this string date)
        {
            ...
            return isValidMatch && DateTime.TryParse(date, out _);
        }
        ...
        {
            return subject.isNullOrEmpty() ? string.Empty : subject.Substring(0, 1).ToUpper() + subject.Substring(1);
        }
        ...
        public static DateTime ConvertStringToDate(this string dateTime)
        {
            ...
            return DateTime.ParseExact(dateTime,
                MonthDayYear, CultureInfo.InvariantCulture);
        }
    }
}
