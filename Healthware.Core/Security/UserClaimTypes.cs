namespace Healthware.Core.Security
{
    ...
    public static class UserClaimTypes
    {
        ...
        public static string AssessmentId { get; set; } = "http://activeassist.zucisystems.com/identity/claims/AssessmentId";
        public static string PatientId { get; set; } = "http://activeassist.zucisystems.com/identity/claims/PatientId";
    }
}
